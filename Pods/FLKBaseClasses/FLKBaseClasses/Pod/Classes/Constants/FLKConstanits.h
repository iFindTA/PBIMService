...
#ifndef FLKConstanits_h
#define FLKConstanits_h
...
/**
 ...
 @param RGB value of hex
 @return the color
 */
#define PBColorMake(RGB)    [UIColor colorWithRed:((RGB >> 16)&0xFF)/255.0 green:((RGB >> 8)&0xFF)/255.0 blue:(RGB&0xFF)/255.0 alpha:1.0f]

/**
 登录相关的常量定义
 */
FOUNDATION_EXTERN NSString * const PB_STORAGE_DB_NAME;
FOUNDATION_EXTERN NSString * const PB_SERVICE_GROUP_IDENTIFIER;
